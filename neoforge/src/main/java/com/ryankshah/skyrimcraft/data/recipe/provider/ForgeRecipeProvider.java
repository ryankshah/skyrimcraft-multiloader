...
//                .save(consumer, Constants.MODID + ":recipes/forge/" + ItemRegistry.STEEL_ARROW.getId().getPath()));
        ...
        consumer.accept(
                ResourceLocation.fromNamespaceAndPath(com.ryankshah.skyrimcraft.Constants.MODID, "forge/" + BuiltInRegistries.ITEM.getKey(ItemRegistry.STEEL_WARHAMMER.get()).getPath()),
