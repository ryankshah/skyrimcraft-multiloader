...
public class PowerAdrenalineRush extends Spell
{
    ...
    public ResourceLocation getDisplayAnimation() {
        return ResourceLocation.fromNamespaceAndPath(Constants.MODID, "spells/adrenaline_rush.png");
    }

    @Override
    public ResourceLocation getIcon() {
        return ResourceLocation.fromNamespaceAndPath(Constants.MODID, "spells/icons/adrenaline.png");
    }
    ...
    @Override
    public void onCast() {
        getCaster().addEffect(new MobEffectInstance(ModEffects.ADRENALINE_RUSH.asHolder(), 1200, 0, false, true, true));
        super.onCast();
    }
}