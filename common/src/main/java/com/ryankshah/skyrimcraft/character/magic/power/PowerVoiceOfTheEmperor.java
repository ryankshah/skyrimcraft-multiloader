...
public class PowerVoiceOfTheEmperor extends Spell
{
    ...
    public ResourceLocation getDisplayAnimation() {
        return ResourceLocation.fromNamespaceAndPath(Constants.MODID, "spells/voice_of_the_emperor.png");
    }

    @Override
    public ResourceLocation getIcon() {
        return ResourceLocation.fromNamespaceAndPath(Constants.MODID, "spells/icons/voice_of_the_emperor.png");
    }
    ...
    public void onCast() {
        ...
        for(Raider raider : raiders) {
            raider.addEffect(new MobEffectInstance(ModEffects.CALM.asHolder(), 1200));
        }
        super.onCast();
    }
}