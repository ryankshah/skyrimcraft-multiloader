...
public class PowerHighborn extends Spell
{
    ...
    public ResourceLocation getIcon() {
        return ResourceLocation.fromNamespaceAndPath(Constants.MODID, "spells/icons/highborn.png");
    }
    ...
    @Override
    public void onCast() {
        getCaster().addEffect(new MobEffectInstance(ModEffects.MAGICKA_REGEN.asHolder(), 1200, 0, true, true, true));
