...
public class CyrodilicSpadetail extends TropicalFish
{
    public CyrodilicSpadetail(EntityType<? extends TropicalFish> pEntityType, Level pLevel) {
        super(pEntityType, pLevel);
    }

    public static boolean checkSpawnRules(
            EntityType<CyrodilicSpadetail> pTropicalFish, LevelAccessor pLevel, MobSpawnType pSpawnType, BlockPos pPos, RandomSource pRandom
    ) {
