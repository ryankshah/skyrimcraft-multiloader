...
//        setPrevAnimationState(this.getAnimationState());
    ...
    private <E extends ValeSabreCat> PlayState sabreCatController(final software.bernie.geckolib.animation.AnimationState<ValeSabreCat> event) {
        AnimationController<ValeSabreCat> controller = event.getController();
